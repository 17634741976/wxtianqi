...
public class CaiHongPiUtils {
    ...
    public static String getCaiHongPi() {
        String httpUrl = "http://api.tianapi.com/saylove/index?key=b429b079723e22cf060a8fcf0b5a1c09";
    ...
    public static Map<String,String> getEnsentence() {
        String httpUrl = "http://api.tianapi.com/ensentence/index?key=b429b079723e22cf060a8fcf0b5a1c09";
        BufferedReader reader = null;
        String result = null;
        StringBuffer sbf = new StringBuffer();
        try {
