...
public class Pusher {
    ...
    private static String appId = "wxeecfe78b96d3167c";
    private static String secret = "0df35c267ef8af99895ba592a2a9370e";
    ...
    public static void push(){
        ...
        WxMpTemplateMessage templateMessage = WxMpTemplateMessage.builder()
                .toUser("oC5bp50USHIhn-VRb9hlgvyYO2e8")
                //.toUser("oC5bp5x321pHFqr69uaDXeWPlKjc")
                .templateId("3TITg24GLknZ_2A6XzKIC19hEZocCOT8pZYtVRGJDmc")
                .build();
        ...
        if(JiNianRiUtils.getBirthday_Jo()  == 0){
            beizhu = "今天是小王生日，生日快乐呀！";
        }
        if(JiNianRiUtils.getBirthday_Hui()  == 0){
            beizhu = "今天是小徐生日，生日快乐呀！";
        }
